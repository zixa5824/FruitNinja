...
public class GuiClassic{

    private Scene scene;

    GuiClassic(Stage stage)
    {
        //-------
        ...
        */
        ...
        RotateTransition appleRotate = new RotateTransition(Duration.millis(2500), ivApple);
        appleRotate.setCycleCount(2);
        ...
        RotateTransition appleRotate1 = new RotateTransition(Duration.millis(2500), ivAppleCut);
        appleRotate1.setCycleCount(2);
